...
<#-- 额外属性列表 -->
<#assign attributeItems=goodsDesc.customAttributeItems?eval>
<#-- 规格列表 -->
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<#if (imgList?size>0)>
							<span class="jqzoom"><img jqimg="${imgList[0].url}" src="${imgList[0].url}" width="400px" height="400px"/></span>
						</#if>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelectSpecification('${spec.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<botton class="increment plus" ng-click="calNum(+1)">+</botton>
										<botton class="increment mins" ng-click="calNum(-1)">-</botton>
									</div>
								</div>
							</div>
							<div class="fl">
